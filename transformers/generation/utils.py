...
class GenerationMixin:
    ...
    def generate(
        ...
        hallucination_layer: Optional[int] = None,
        ...
        **kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            hallucination_layer=hallucination_layer,
        ...
        **model_kwargs,
        ...
        with torch.no_grad():
            while True:
                ...
                if hallucination_layer is not None:
                    hallucination_logits = dict_outputs[hallucination_layer]
