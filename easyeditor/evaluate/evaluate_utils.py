...
def test_safety_gen(
    ...
    # if input_tokens (at least 1024) + output_tokens (at least 300) < 1624, truncate the input length (from right to left, as harmful questions typically appear on the right)
    if max_tokens < 1624:
        only_response = []
            ...
            with torch.no_grad():
                ...
                if(ddsc==True):
                    ...
                    **input,
                    ...
                    outputs,safe_layer,toxic = model.generate(ddsc,**input, max_new_tokens=max_output_tokens,do_sample=False,pad_token_id=tokenizer.pad_token_id)
